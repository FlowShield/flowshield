...
# FlowShield-****FVM**** build notes  [(whitepaper)](https://www.FlowShield.xyz/FlowShield_whitepaper/)

- [FlowShield-****FVM**** build notes  (whitepaper)](#flowshield-fvm-build-notes--whitepaper)
  ...
  - [How is **FVM**, Filecoin, IPFS technology used in this project](#how-is-fvm-filecoin-ipfs-technology-used-in-this-project)
    - [FlowShield-Fullnode - build with IPFS|libp2p](#flowshield-fullnode---build-with-ipfslibp2p)
    - [FlowShield-Provider - build with IPFS|libp2p](#flowshield-provider---build-with-ipfslibp2p)
  ...
  - [**FVM**'s current work contents](#fvms-current-work-contents)
    - [FlowShield-contracts **FVM** adaptation process record](#flowshield-contracts-fvm-adaptation-process-record)
    - [Deploy the contract on `wallaby`](#deploy-the-contract-on-wallaby)
    - [FlowShield-provider **FVM** adaptation process record](#flowshield-provider-fvm-adaptation-process-record)
...
### FlowShield-Fullnode - build with IPFS|libp2p
...
### FlowShield-Provider - build with IPFS|libp2p
...
### FlowShield-contracts **FVM** adaptation process record
### Deploy the contract on `wallaby`

Our contract warehouse address is [https://github.com/FlowShield-project/FlowShield/tree/fevm-testnet/contract](https://github.com/FlowShield/FlowShield/tree/fevm-testnet/contract)
...
yarn run v1.22.17
$ /Users/chengqiang/icode/github/FlowShield/FlowShield/contract/node_modules/.bin/hardhat deploy
You have both ethereum-waffle and @nomicfoundation/hardhat-chai-matchers installed. They don't work correctly together, so please make sure you only use one.
...
### FlowShield-provider **FVM** adaptation process record
